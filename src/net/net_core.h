...
internal Net_RecieveResult net_socket_receive(Net_Socket connected_socket, U8 *buffer, U64 buffer_size);
internal Net_RecieveResult net_socket_receive_from(Net_Socket listen_socket, Net_Address *address, U8 *buffer, U64 buffer_size);
